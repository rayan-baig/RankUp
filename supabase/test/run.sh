...
for f in "$HERE/../schema.sql" "$HERE/../sync.sql" "$HERE/../guilds.sql" "$HERE/../notifications.sql" "$HERE/../consent.sql" "$HERE/../billing.sql" "$HERE/../alliances.sql" "$HERE/../reminders.sql" "$HERE/00b-helpers.sql"; do
